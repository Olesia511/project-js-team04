import"./sup-ukraine-271de127.js";const c=document.querySelector(".shop-list-list"),r=document.querySelector(".shop-list-placeholder"),i="user-books";function m(){const o=document.querySelector(".js-description"),s=o.textContent;if(window.innerWidth<768){const e=s.slice(0,86)+"…";o.textContent=e}else if(window.innerWidth>=768&&window.innerWidth<1440){const e=s.slice(0,253)+"…";o.textContent=e}else o.textContent=s}let t;localStorage.getItem(i)?t=JSON.parse(localStorage.getItem(i)):t=[];function a(o){const s=o.map(({buy_links:e="null",amazon_product_url:n="null",book_image:p="null",title:l="null",list_name:d="null",description:g="null",author:h,_id:u="null"})=>`<li class="shop-list-item" data-id="${u}">
