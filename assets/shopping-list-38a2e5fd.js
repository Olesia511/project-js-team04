import"./sup-ukraine-2c6e1869.js";const l=document.querySelector(".shop-list-list"),c=document.querySelector(".shop-list-placeholder"),r="user-books";function m(){const o=document.querySelector(".js-description"),t=o.textContent;if(window.innerWidth<768){const e=t.slice(0,86)+"…";o.textContent=e}else if(window.innerWidth>=768&&window.innerWidth<1440){const e=t.slice(0,253)+"…";o.textContent=e}else o.textContent=t}const n=JSON.parse(localStorage.getItem(r));function a(o){const t=o.map(({buy_links:e="null",amazon_product_url:s="null",book_image:p="null",title:i="null",list_name:d="null",description:g="null",author:h,_id:u="null"})=>`<li class="shop-list-item" data-id="${u}">
