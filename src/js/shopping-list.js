...
const parsedLocalData = JSON.parse(localStorage.getItem("obj"));
console.log(parsedLocalData);

function shopListMarkup(arr) {
    const markup = arr.map(({ buy_links, amazon_product_url, book_image, title, list_name, description, author }) => {
